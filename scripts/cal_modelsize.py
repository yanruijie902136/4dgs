...
def calculate_total_size_of_files(folders):
    ...
    for folder_name in folders:
        deformation_path = os.path.join(
            folder_name, "./point_cloud/coarse_iteration_3000/deformation.pth")
        point_cloud_path = os.path.join(
            folder_name, "./point_cloud/coarse_iteration_3000/point_cloud.ply")
...
for model_name in ["dnerf_3dgs"]:
    # model_name = "dnerf_tv"
    folder_names = ["bouncingball", "hook", "hellwarrior",
                    "jumpingjack", "lego", "mutant", "standup", "trex"]
    new_folder_names = [os.path.join("output", model_name, i)
